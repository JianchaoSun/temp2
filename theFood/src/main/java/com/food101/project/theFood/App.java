...
public class App {
    ...
    public static void main(String[] args) throws Throwable {
    	...
    	FileInputStream serviceAccount =
    			...
    			foodRecipe food1 = new foodRecipe("ChikenBeefMix",food,null, "beef");
...
List<Meat> food2 = new ArrayList<Meat>();
    			...
    			food2.add(new Meat("green", 10,"hh.com",3));
    			food2.add(new Meat("red", 13,"hw3h.com",2.5));
    			
    			foodRecipe food3 = new foodRecipe("greenfood",food2,null, "green");
