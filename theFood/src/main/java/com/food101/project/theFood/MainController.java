...
AppUser user = search.findUserbyUsername(username);
	      ...
	      Food[] food = new Food[2];//s.findFood("xx1");
	      food[0] = new Meat("tomato", 0, "dd", 0);
	      food[1] = new Meat("beefs", 0, "dsd", 0);
	    ...
	    public String index(String searchInput,Model model) throws InterruptedException, ExecutionException {
			...
			*/
			 ...
			 Food[] food = new Food[2];//s.findFood("xx1");
		      food[0] = new Meat("beef", 0, "dd", 0);
		      food[1] = new Meat("beefs", 0, "dsd", 0);
		      
		      //System.out.print(name);
		      model.addAttribute("Veges", food);
		      model.addAttribute("Meats", food);
		      model.addAttribute("Conds", food);
